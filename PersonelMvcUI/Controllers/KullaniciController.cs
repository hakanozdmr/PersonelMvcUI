...
namespace PersonelMvcUI.Controllers
{
    ...
    public class KullaniciController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Ad,Sifre,Rol")]  KullaniciCreateViewModel   kullaniciCreateViewModel)
        {
            Kullanici kullanici = new Kullanici
            {
                Ad = kullaniciCreateViewModel.Ad,
                Id=kullaniciCreateViewModel.Id,
                Role = kullaniciCreateViewModel.Rol,
                Sifre=kullaniciCreateViewModel.Sifre
            };
            ...
            return View(kullaniciCreateViewModel);
        }
